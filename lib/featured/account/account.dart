...
import 'package:flower_admin/common/widgets/texts/section_heading.dart';
import 'package:flower_admin/data/models/Admins.dart';
import 'package:flower_admin/featured/account/widgets/profile_menu.dart';
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  void loadAdminDetail() async {
    try {
      final adminDetailResponse = await adminApiHandler.getAdminDetail();
      setState(() {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TProfileMenu(title: 'Họ tên', value: '${adminDetail['adName']}', onPressed: () {}),
              ...
              TProfileMenu(title: 'ID người dùng', value: '${adminDetail['adminId']}', icon: Iconsax.copy, onPressed: () {}),
